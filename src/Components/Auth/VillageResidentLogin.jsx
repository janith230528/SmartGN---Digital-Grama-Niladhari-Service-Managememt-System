...
function VillageResidentLogin({ onRegisterLink, onBack, onSubmit }) {
  ...
  return (
    <div className="w-full bg-[#F5F8FC]/95 backdrop-blur-md rounded-[32px] shadow-2xl p-6 sm:p-10 md:p-12 border border-white/50 flex flex-col items-center max-w-[550px] transition-all duration-300">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col">
        ...
        {/* Register Redirect */}
        <div className="text-center text-xs font-semibold text-slate-500 mb-8">
...
export default VillageResidentLogin;
